...
public class TestableCodeTest {
    ...
    private static preparingcode.TestableCode tc = new preparingcode.TestableCode();
    @Test
    ...
    public void testDayPart() {
        ...
        assertEquals(outcome, tc.greetUser(String.valueOf(dateTime)));
    }
}